...
export default <SlashCommand>{
    ...
    subcommand
      .addStringOption((option) =>
        option
          ...
          .setDescription('Type of reminder, separate different type with space. e.g. hunt adv use')
          .setRequired(true)
      )
      .addStringOption((option) =>
  ...
  execute: async (client, interaction) => {
    ...
    const optionAction = interaction.options.getString('action', true) as 'set' | 'remove';
